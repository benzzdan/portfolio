...
tl.from(bgd, 0.2, { opacity: 0, scale: 0, transformOrigin: 'center center' })
    ...
    .staggerFrom(computer, 0.1, { opacity: 0, scale: 0, transformOrigin: 'center center', ease: Back.easeOut }, 0.1)
    .staggerFrom(keyboard, 0.1, { opacity: 0, y: '-=100', ease: Linear.easeInOut }, 0.02)
    .staggerFrom(asset, 0.1, { opacity: 0 }, 0.05)
    ...
    .to(bgd, 0.2, { opacity: 1, fill: '#363636' })
...
//Smooth scrolling a tags nav bar

$('#navbarMenuHeroA a').click(function() {
    $('html, body').animate({
