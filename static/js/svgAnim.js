...
tl.from(bgd, 0.2, { opacity: 0, scale: 0, transformOrigin: 'center center' })
    ...
    .staggerFrom(computer, 1, { opacity: 0, scale: 0, transformOrigin: 'center center', ease: Back.easeOut }, 0.1)
    .staggerFrom(keyboard, 0.5, { opacity: 0, y: '-=100', ease: Linear.easeInOut }, 0.03)
